      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {statCards.map((card, index) => (
          <motion.div
            ...
            className={`${card.color} border rounded-xl p-4 md:p-6 transition-all hover:shadow-md`}
          >
            <div className="flex flex-col items-center text-center">
              <div className={`w-10 h-10 md:w-12 md:h-12 ${card.color} rounded-full flex items-center justify-center mb-3`}>
