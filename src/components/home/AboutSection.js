  ...
  const features = [
    {
      icon: FiTarget,
      title: 'আমাদের লক্ষ্য',
      description: 'ফুলতলা ও ডুমুরিয়াবাসীর সমস্যা দ্রুত সমাধানের মাধ্যমে একটি উন্নত ও সমৃদ্ধ এলাকা গড়ে তোলা।'
    },
    {
      icon: FiUsers,
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed">
          সমাধা হলো ফুলতলা ও ডুমুরিয়াবাসীর জন্য একটি ডিজিটাল প্ল্যাটফর্ম যেখানে তারা তাদের 
