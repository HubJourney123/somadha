  ...
  return (
    <div className="min-h-screen bg-secondary-50 dark:bg-dark-bg">
      ...
      <main className="with-bottom-nav">
        ...
        {/* Search and Filter Section - With Margin */}
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-lg border border-secondary-300 dark:border-neutral-600 bg-white dark:bg-dark-card text-neutral-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary"
                />
                {searchQuery && (
                  <button
              ...
              <div className="md:w-64">
                <div className="relative">
                  <FiFilter className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-neutral-400" />
                  <select
                    value={filterStatus}
                    onChange={(e) => setFilterStatus(e.target.value)}
                    className="w-full pl-10 pr-4 py-3 rounded-lg border border-secondary-300 dark:border-neutral-600 bg-white dark:bg-dark-card text-neutral-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary appearance-none cursor-pointer"
                  >
        ...
        <div className="px-4 md:px-6 pb-6">
          {loading ? (
            ...
            >
              {searchQuery || filterStatus !== 'all' ? (
                <>
                  <div className="w-16 h-16 bg-secondary-100 dark:bg-neutral-800 rounded-full flex items-center justify-center mx-auto mb-4">
